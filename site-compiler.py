...
def compile_directory(root, template):
...
def build_index(root, processed, template):
	inner = ''
	indexMarkdown = '## Site Index\n\n %s \n\n This is an index auto-generated by site-compiler.\n\n'
	...
	html = template.format(markdown(indexMarkdown % inner))
...
def main():
	...
	for directory in args.directories:
		compile_directory(directory, template)
